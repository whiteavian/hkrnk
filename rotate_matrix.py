def rotate_matrix_n_times(mat, m, n, times):
    ...
    for indent in xrange(min(m, n) / 2):
        ...
        i, j = i_fill, j_fill
        i, j = get_next_indices(i, j, m, n, indent, local_times)
